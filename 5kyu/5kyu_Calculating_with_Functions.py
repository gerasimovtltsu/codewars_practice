...
def plus(res): return lambda num: num + res
def minus(res): return lambda num: num - res
def times(res): return lambda num: num * res
def divided_by(res): return lambda num: num / res